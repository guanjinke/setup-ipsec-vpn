...
如需在 DigitalOcean 上安装，可以参考这个<a href="https://usefulpcguide.com/17318/create-your-own-vpn/" target="_blank">详细的分步指南</a>。该指南由 Tony Tran 编写。
